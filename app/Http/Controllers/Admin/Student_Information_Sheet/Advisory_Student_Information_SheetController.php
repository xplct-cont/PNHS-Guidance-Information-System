...
class Advisory_Student_Information_SheetController extends Controller
{
    ...
    public function destroy($id){
      ...
      {
          $advStudents_student_information_sheet = Student_Information_Sheet::findOrFail($id);
          $pdf = PDF::loadVIew('pdf.adv-student_information_sheet', [
              'student_information_sheets' => $advStudents_student_information_sheet
          ]);
  
          return $pdf->download('Student Information Sheet.pdf');
      }
