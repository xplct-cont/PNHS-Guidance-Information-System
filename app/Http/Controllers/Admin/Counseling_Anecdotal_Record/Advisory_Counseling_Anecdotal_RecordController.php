...
class Advisory_Counseling_Anecdotal_RecordController extends Controller
{
    ...
    public function destroy($id){
      ...
      public function export_advStudents_Counseling_Anecdotal_ID_pdf(Request $request, $id){
        $advStudents_Counseling_Anecdotal = Counseling_Anecdotal_Record::findOrFail($id);
        $pdf = PDF::loadVIew('pdf.adv-counseling_anecdotal', [
            'counseling_anecdotal_records' => $advStudents_Counseling_Anecdotal
        ]);
        return $pdf->download('Counseling Anecdotal Record.pdf');
      }
}