...
class Advisory_Parent_Conference_RecordController extends Controller
{
    ...
    public function destroy($id){
      ...
      public function export_advStudents_Parent_Conference_Record_ID_pdf(Request $request, $id){
        $advStudents_Parent_Conference_Record = Parent_Conference_Record::findOrFail($id);
        $pdf = PDF::loadVIew('pdf.adv-parent-conference-record', [
            'parent_conference_records' => $advStudents_Parent_Conference_Record
        ]);
        return $pdf->download('Parent Conference Record.pdf');
    }
