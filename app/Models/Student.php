...
class Student extends Model
{
    ...
    protected $fillable =['user_id', 'school_id', 'firstname', 'lastname', 'middlename', 'gender',  'age', 'year_section', 'email', 'parent_name', 'parent_email', 'address', 'parent_num', 'school_year'];
