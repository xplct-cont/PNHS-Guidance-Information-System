...
<body>
    ...
    <div class="">
        <p style="font-size: 14px;">Name: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->student->firstname }}
                {{ $student_information_sheets->student->middlename }}
                {{ $student_information_sheets->student->lastname }}</span></p>
    </div>
    <div class="" style="margin-top: -10px;">
        <p style="font-size: 14px;">Name and Address of School Last Attended: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->last_attended_school }}</span>
        </p>
    </div>
    <div class="" style="margin-top: -10px;">
        <p style="font-size: 14px;">Year/Section: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->student->year_section }}</span>
        </p>
    </div>
    <div class="" style="margin-top: -10px;">
    ...
    <hr>
    <div class="">
        <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:16px; font-weight:500;">
            PERSONAL DATA</p>
    </div>
    <div class="">
        <p style="font-size: 14px;">Date of Birth: <span
                style="border-bottom: 1px solid dimgray;">{{ Carbon\Carbon::parse($student_information_sheets->birthdate)->format('F d, Y') }}</span>
        </p>
    </div>
    <div class="">
    ...
    <div class="" style=" position:absolute; top: 506px;  margin-left: 400px; text-align: end;">
        <p style="font-size: 14px">Home Address: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->student->address }}</span>
        </p>
    </div>
    <div class="" style=" position:absolute; top: 549px;  margin-left: 400px; text-align: end;">
        <p style="font-size: 14px">Sex: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->student->gender }}</span>
        </p>
    </div>
    ...
    <div class="">
        <p style="font-size: 14px;">Secondary Honor/s Received: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->secon_honors_rec }}</span>
        </p>
    </div>
    ...
    <div class="" style=" position:absolute; top: 851px;  margin-left: 400px; text-align: end;">
        <p style="font-size: 14px">Year Graduated in Secondary: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->secon_year_grad }}</span>
        </p>
    </div><br><br>
    <hr>
    <div class="">
        <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:16px; font-weight:500;">(FOR
            TRANSFEREE/SHIFTEE/CROSS ENROLLEE, WRITE SCHOOL/S ATTENDED)</p>
    </div>
    <div class="">
        <p style="font-size: 14px;">Year Level Last Attended: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->level_last_attended }}</span>
        </p>
    </div>
    <div class="">
    ...
    <div class="">
        <p style="font-size: 14px;">Reasons why transfer: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->reasons_for_transfer }}</span>
        </p>
    </div>
    ...
    <div class="">
        <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:16px; font-weight:500;">
            AFFILIATION IN ORGANIZATION(church, club, school, fraternity, volunteer)</p>
    </div>
    <div class="">
    ...
    <hr>
    <div class="">
        <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:16px; font-weight:500;">SELF
        </p>
    </div>
    <div class="">
    ...
    <div class="">
        <p style="font-size: 14px;">Occupation: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->father_occupation }}</span>
        </p>
    </div>
    <div class="">
    ...
    <div class="" style=" position:absolute; top: 745px;  margin-left: 400px; text-align: end;">
        <p style="font-size: 14px">Occupation: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->mother_occupation }}</span>
        </p>
    </div>
    ...
    <div class="">
        <p style="font-size: 14px;">Father's Educational Status: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->father_educ_stat }}</span>
        </p>
    </div>
    <div class="" style=" position:absolute; top: 905px;  margin-left: 400px; text-align: end;">
        <p style="font-size: 14px">Mother's Educational Status: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->mother_educ_stat }}</span>
        </p>
    </div>
    <div class="">
    ...
    <div class="">
        <p style="font-size: 14px;">(Marital Status of Parents) <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->mar_parents_stat }}</span>
        </p>
    </div>
    <div class="">
    ...
    <div class="">
        <p style="font-size: 14px;">(How are you supported with) <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->how_are_you_supp }}</span>
        </p>
    </div>
    <hr>
    <div class="">
    ...
    <div class="">
        <p style="font-size: 14px;">Father: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->rel_with_father }}</span>
        </p>
    </div>
    <div class="">
        <p style="font-size: 14px;">Brother: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->rel_with_brother }}</span>
        </p>
    </div>
    <div class="" style=" position:absolute; top: 283px;  margin-left: 400px; text-align: end;">
        <p style="font-size: 14px">Mother: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->rel_with_mother }}</span>
        </p>
    </div>
    <div class="" style=" position:absolute; top: 328px;  margin-left: 400px; text-align: end;">
        <p style="font-size: 14px">Sister: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->rel_with_sister }}</span>
        </p>
    </div>
    <hr>
    <div class="">
    ...
    <div class="">
        <p style="font-size: 14px;">Occupation: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->spouse_occupation }}</span>
        </p>
    </div>
    <div class="">
        <p style="font-size: 14px;">Nationality: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->spouse_nationality }}</span>
        </p>
    </div>
    <div class="">
        <p style="font-size: 14px;">Age: <span
    ...
    <div class="">
        <p style="font-size: 14px;">Name and Address of Company: <span
                style="border-bottom: 1px solid dimgray;">{{ $student_information_sheets->spouse_comp_name }}</span>
        </p>
    </div>
    <div class="">
    ...
    <div class="">
        <p style="font-size: 14px;">Date Signed: <span
                style="border-bottom: 1px solid dimgray;">{{ Carbon\Carbon::parse($student_information_sheets->date_signed)->format('F d, Y') }}</span>
        </p>
    </div>
