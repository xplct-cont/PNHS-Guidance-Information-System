...
<body>
    ...
    <div class="container">
        ...
        <div class="rep">
            <h1>REPORT OF CASES OF ABUSE, VIOLENCE, EXPLOITATION, DISCRIMINATION, BULLYING OR PEER ABUSE AND OTHER
                RELATED OFFENSES</h1>
        </div>
        <hr>
        ...
        <div class="">
            <p style="font-size: 14px;">Date Reported: <span
                    style="border-bottom: 1px solid dimgray;">{{ Carbon\Carbon::parse($one_case_report->date_reported)->format('F d,  Y ') }}</span>
            </p>
        </div>

        <div class="" style=" position:absolute; top: 203px;  margin-left: 400px; text-align: end;">
            <p style="font-size: 14px">Respondent Name: <span
                    style="border-bottom: 1px solid dimgray;">{{ $one_case_report->resp_name }}</span> </p>
        </div>

        <div class="" style=" position:absolute; top: 248px;  margin-left: 400px; text-align: end;">
            <p style="font-size: 14px;">Grade and Section: <span
                    style="border-bottom: 1px solid dimgray;">{{ $one_case_report->resp_grade_section }}</span> </p>
        </div>

        <div class="" style=" position:absolute; top: 292px;  margin-left: 400px; text-align: end;">
            <p style="font-size: 14px;">Sex: <span
        ...
        <div class="" style="margin-top: 20px;">
            ...
            <p class="" style="font-size:14px;">Nature of Complaint:
            <p
                style="text-indent:1cm; overflow-wrap: break-word; font-size: 13px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                {{ $one_case_report->nature_of_complaint }}</p>
            </p>

            <p class="" style="font-size:14px;">Actions Taken:
            <p
                style="text-indent:1cm; overflow-wrap: break-word; font-size: 13px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                {{ $one_case_report->actions_taken }}</p>
            </p>

            <p class="" style="font-size:14px;">Recommendations:
            <p
                style="text-indent:1cm; overflow-wrap: break-word; font-size: 13px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                {{ $one_case_report->recommendations }}</p>
            </p>
