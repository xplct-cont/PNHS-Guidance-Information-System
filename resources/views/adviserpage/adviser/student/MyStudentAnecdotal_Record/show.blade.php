...
@section('content')
    <div class="p-1">
        <a class="fas fa-arrow-left" style="font-size:20px; color:blue;"
            href="{{ url('show-my-student/' . $anecdotal_myStud->student->id . '/anecdotal_record_myStudent') }}"></a>
    </div>
        ...
        <div class="col-md-9 elevation-4 p-3 rounded  mt-5 bg-light mb-3">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a class="btn btn-danger mt-2 ml-2 mr-2" style=""
                    href="{{ route('export_myStudents_anecdotal_pdf', $anecdotal_myStud->id) }}"><span
            ...
            <div class="container mx-auto">
                <form action="{{ url('update_anecdotal_record_myStudent/' . $anecdotal_myStud->id) }}" method="POST"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $anecdotal_myStud->observation_date_time->format('F d,  Y - g:i A') }}"
                                    readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $anecdotal_myStud->student->firstname }} {{ $anecdotal_myStud->student->middlename }} {{ $anecdotal_myStud->student->lastname }}"
                                    readonly>
                            ...
                            <div class=" p-2 bg-light" style="border: 1px solid dimgray;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" style="width: 45px;"
                                        name="student_id" value="{{ $anecdotal_myStud->student->id }}" readonly>
                                </div>
                                <br>
