    ...
    <div class="container" style="">
        <div class="">
            <div class="">
                ...
                <a href="{{ url('delete_career_interest_test_result/' . $car_inter_wis->id) }}"
                    class="btn btn-sm btn-danger mb-1"><i class="text-light fas fa-trash"></i> Delete</a>
                    <a href="{{ url('download_career_interest_test_result',$car_inter_wis->id) }}" class="btn btn-sm btn-primary mb-1"><i class="text-light fas fa-download"></i> Download </a>
