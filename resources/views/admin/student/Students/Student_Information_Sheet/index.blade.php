...
@section('content')
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('/upload_student_information') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $student_wis->year_section }}" readonly>
                                    </div>
                                    <div class="form-group">
    ...
    @forelse ($student_information_sheet_wisdom as $stud_info_wis)
        <form action="{{ url('update_student_information_sheet/' . $stud_info_wis->id) }}" method="POST"
            accept-charset="UTF-8">
            @csrf
            @method('PUT')

            <div class="row d-flex justify-content-center text-dark">
                <div class="col-md-9 elevation-4 p-3 rounded  mt-2 bg-light mb-3">

                    <a href="#" data-toggle="modal" id="stud_info_wis_delete_link" class="btn btn-danger btn-sm"
                        data-target="#stud_info_wis_id{{ $stud_info_wis->id }}"><span
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a class="btn btn-danger mt-2 ml-2 mr-2" style=""
                            href="{{ route('export_advStudents_student_information_sheet_pdf', $stud_info_wis->id) }}"><span
                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-5">
                                    ...
                                    <input type="text" class="form-control" name="type_of_student"
                                        value="{{ $stud_info_wis->type_of_student }}">
                                </div>
                        ...
                        <hr>
                        <p class="text-center text-dark">NOTE: All information are held strictly
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $stud_info_wis->student->lastname }}, {{ $stud_info_wis->student->firstname }} {{ $stud_info_wis->student->middlename }}"
                                            readonly>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" style="color:dimgray">Name and Address of School Last
                                            Attended: </label>
                                        <input type="text" class="form-control" name="last_attended_school"
                                            value="{{ $stud_info_wis->last_attended_school }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Year/Section: </label>
                                    <input type="text" class="form-control"
                                        value="{{ $stud_info_wis->student->year_section }}" readonly>

                                </div>
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">School Year: </label>
                                    <input type="text" class="form-control" name="school_year"
                                        value="{{ $stud_info_wis->school_year }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="birthdate"
                                        value="{{ $stud_info_wis->birthdate }}">
                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Nationality: </label>
                                    <input type="text" class="form-control" name="nationality"
                                        value="{{ $stud_info_wis->nationality }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Status: </label>
                                    <input type="text" class="form-control" name="status"
                                        value="{{ $stud_info_wis->status }}">
                                ...
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Age: </label>
                                    <input type="text" class="form-control"
                                        value="{{ $stud_info_wis->student->age }}" readonly>

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Height: </label>
                                    <input type="text" class="form-control" name="height"
                                        value="{{ $stud_info_wis->height }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Mobile Number: </label>
                                    <input type="text" class="form-control" name="number"
                                        value="{{ $stud_info_wis->number }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Place of Birth: </label>
                                    <input type="text" class="form-control" name="birthplace"
                                        value="{{ $stud_info_wis->birthplace }}">

                                </div>
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Religion: </label>
                                    <input type="text" class="form-control" name="religion"
                                        value="{{ $stud_info_wis->religion }}">

                                </div>
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Home Address: </label>
                                    <input type="text" class="form-control"
                                        value="{{ $stud_info_wis->student->address }}" readonly>

                                </div>
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Sex: </label>
                                    <input type="text" class="form-control"
                                        value="{{ $stud_info_wis->student->gender }}" readonly>

                                </div>
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Weight: </label>
                                    <input type="text" class="form-control" name="weight"
                                        value="{{ $stud_info_wis->weight }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Elementary: </label>
                                    <input type="text" class="form-control" name="elementary"
                                        value="{{ $stud_info_wis->elementary }}">
                                </div>
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Secondary: </label>
                                    <input type="text" class="form-control" name="secondary"
                                        value="{{ $stud_info_wis->secondary }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Elementary Honor/s Received: </label>
                                    <input type="text" class="form-control" name="elem_honors_rec"
                                        value="{{ $stud_info_wis->elem_honors_rec }}">

                                </div>
                                <div class="form-group ">
                                    <label for="" style="color:dimgray">Secondary Honor/s Received: </label>
                                    <input type="text" class="form-control" name="secon_honors_rec"
                                        value="{{ $stud_info_wis->secon_honors_rec }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <div class="form-group ">
                                        <label for="" style="color:dimgray">Year Graduated in Elementary: </label>
                                        <input type="text" class="form-control" name="elem_year_grad"
                                            value="{{ $stud_info_wis->elem_year_grad }}">
                                ...
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Year Graduated in Secondary: </label>
                                    <input type="text" class="form-control" name="secon_year_grad"
                                        value="{{ $stud_info_wis->secon_year_grad }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Year Level Last Attended: </label>
                                    <input type="text" class="form-control" name="level_last_attended"
                                        value="{{ $stud_info_wis->level_last_attended }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Reason/s why transfer: </label>
                                    <input type="text" class="form-control" name="reasons_for_transfer"
                                        value="{{ $stud_info_wis->reasons_for_transfer }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">School and Address: </label>
                                    <input type="text" class="form-control" name="school_add"
                                        value="{{ $stud_info_wis->school_add }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Favorite Subject: </label>
                                    <input type="text" class="form-control" name="fav_sub"
                                        value="{{ $stud_info_wis->fav_sub }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Likes: </label>
                                    <input type="text" class="form-control" name="likes"
                                        value="{{ $stud_info_wis->likes }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Most Difficult Subject: </label>
                                    <input type="text" class="form-control" name="most_dif_sub"
                                        value="{{ $stud_info_wis->most_dif_sub }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Father: </label>
                                    <input type="text" class="form-control" name="father"
                                        value="{{ $stud_info_wis->father }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Age: </label>
                                    <input type="text" class="form-control" name="father_age"
                                        value="{{ $stud_info_wis->father_age }}">
                                ...
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Occupation: </label>
                                    <input type="text" class="form-control" name="father_occupation"
                                        value="{{ $stud_info_wis->father_occupation }}">
                                ...
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Office Address: </label>
                                    <input type="text" class="form-control" name="father_off_ad"
                                        value="{{ $stud_info_wis->father_off_ad }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Mother: </label>
                                    <input type="text" class="form-control" name="mother"
                                        value="{{ $stud_info_wis->mother }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Age: </label>
                                    <input type="text" class="form-control" name="mother_age"
                                        value="{{ $stud_info_wis->mother_age }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Occupation: </label>
                                    <input type="text" class="form-control" name="mother_occupation"
                                        value="{{ $stud_info_wis->mother_occupation }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Office Address: </label>
                                    <input type="text" class="form-control" name="mother_off_ad"
                                        value="{{ $stud_info_wis->mother_off_ad }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="father_educ_stat"
                                        value="{{ $stud_info_wis->father_educ_stat }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mother_educ_stat"
                                        value="{{ $stud_info_wis->mother_educ_stat }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="monthly_income"
                                        value="{{ $stud_info_wis->monthly_income }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mar_parents_stat"
                                        value="{{ $stud_info_wis->mar_parents_stat }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="rank_order"
                                        value="{{ $stud_info_wis->rank_order }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">No. of Brothers: </label>
                                    <input type="text" class="form-control" name="no_of_brothers"
                                        value="{{ $stud_info_wis->no_of_brothers }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">No. of Sisters: </label>
                                    <input type="text" class="form-control" name="no_of_sisters"
                                        value="{{ $stud_info_wis->no_of_sisters }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="living_with"
                                        value="{{ $stud_info_wis->living_with }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="how_are_you_supp"
                                        value="{{ $stud_info_wis->how_are_you_supp }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Father: </label>
                                    <input type="text" class="form-control" name="rel_with_father"
                                        value="{{ $stud_info_wis->rel_with_father }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Mother: </label>
                                    <input type="text" class="form-control" name="rel_with_mother"
                                        value="{{ $stud_info_wis->rel_with_mother }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Brother: </label>
                                    <input type="text" class="form-control" name="rel_with_brother"
                                        value="{{ $stud_info_wis->rel_with_brother }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Sister: </label>
                                    <input type="text" class="form-control" name="rel_with_sister"
                                        value="{{ $stud_info_wis->rel_with_sister }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Name of Spouse: </label>
                                    <input type="text" class="form-control" name="spouse_name"
                                        value="{{ $stud_info_wis->spouse_name }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Occupation: </label>
                                    <input type="text" class="form-control" name="spouse_occupation"
                                        value="{{ $stud_info_wis->spouse_occupation }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Nationality: </label>
                                    <input type="text" class="form-control" name="spouse_nationality"
                                        value="{{ $stud_info_wis->spouse_nationality }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Age: </label>
                                    <input type="text" class="form-control" name="spouse_age"
                                        value="{{ $stud_info_wis->spouse_age }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Name and Address of Company: </label>
                                    <input type="text" class="form-control" name="spouse_comp_name"
                                        value="{{ $stud_info_wis->spouse_comp_name }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Company Tel/Mobile No.: </label>
                                    <input type="text" class="form-control" name="company_num"
                                        value="{{ $stud_info_wis->company_num }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Past Disease: </label>
                                    <input type="text" class="form-control" name="past_disease"
                                        value="{{ $stud_info_wis->past_disease }}">
                                ...
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Injuries of Illness: </label>
                                    <input type="text" class="form-control" name="injuries"
                                        value="{{ $stud_info_wis->injuries }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Previous Hospitalization/Operations:
                                    </label>
                                    <input type="text" class="form-control" name="operations"
                                        value="{{ $stud_info_wis->operations }}">

                                </div>
                                <div class="form-group">
                                    <label for="" style="color:dimgray">Menstrual History (Female Only):
                                    </label>
                                    <input type="text" class="form-control" name="mens_history"
                                        value="{{ $stud_info_wis->mens_history }}">

                                </div>
                            </div>
                        </div>
                        <hr>
                        <p class="text-dark mt-2 mb-5"><i class="text-dark">I certify that all information above are
                                true
                                and
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="" style="color:dimgray">Date Signed: </label>
                                <div style="font-size:15px;">YYYY-MM-DD</div>
                                <input type="text" class="form-control" name="date_signed"
                                    value="{{ $stud_info_wis->date_signed->format('Y-m-d') }}">

                                <label for="" style="color:dimgray">Student ID: </label>
                                <input type="text" class="form-control text-center" style="width: 45px;"
                                    name="student_id" value="{{ $stud_info_wis->student_id }}" readonly>
                            </div>
                        </div>
                        <br>
        ...
        <div class="modal fade" id="stud_info_wis_id{{ $stud_info_wis->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ url('delete_student_information_sheet/' . $stud_info_wis->id) }}"
