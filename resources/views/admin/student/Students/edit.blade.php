...
@section('content')
    ...
    <div class="row d-flex justify-content-center text-dark">
        <div class="col-md-8 p-2 rounded bg-light">
            ...
            <div class="container elevation-3 col-md-10">
                ...
                <form action="{{ url('update-student/' . $advisoryStud->id) }}" method="POST" accept-charset="UTF-8">
                    ...
                    <div class="input-group mb-3 mt-4">
                        <label for="" style="color:dimgray;"><span class=" input-group-text bg-secondary"
                                style="width: 220px;">Student ID</span></label>
                    ...
                    <div class="input-group mb-3 ">
                        <label for="" style="color:dimgray;"><span class=" input-group-text bg-secondary"
                                style="width: 220px;">Lastname</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class="input-group-text bg-secondary"
                                style="width: 220px;">Firstname</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class="input-group-text bg-secondary"
                                style="width: 220px;">Midlename</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class="input-group-text bg-secondary"
                                style="width: 220px;">Yr./Section</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class="input-group-text bg-secondary"
                                style="width: 220px;">Age</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class="input-group-text bg-secondary"
                                style="width: 220px;">Email</span></label>
                        <input type="email" name="email" class="form-control" value="{{ $advisoryStud->email }}"
                            required>
                    </div>

                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class=" input-group-text bg-secondary"
                                style="width: 220px;">Parent/Guardian Name</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class="input-group-text bg-secondary"
                                style="width: 220px;">Parent/Guardian Email</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class="input-group-text bg-secondary"
                                style="width: 220px;">Parent/Guardian Phone No.</span></label>
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class=" input-group-text bg-secondary"
                                style="width: 220px;">Address</span></label>
                        <input type="text" name="address" class="form-control" value="{{ $advisoryStud->address }}"
                            required>
                    </div>
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span class=" input-group-text bg-secondary"
                                style="width: 220px;">School Year</span></label>
