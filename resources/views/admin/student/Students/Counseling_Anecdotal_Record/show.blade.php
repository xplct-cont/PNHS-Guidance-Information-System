...
@section('content')
    <div class="p-1">
        <a class="fas fa-arrow-left" style="font-size:20px; color:blue;"
            href="{{ url('show-student/' . $student_wisd->student->id . '/counseling_anecdotal_record') }}"></a>
    </div>
        ...
        <div class="col-md-11 elevation-4 p-3 rounded  mt-5 bg-light mb-3">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a class="btn btn-danger mt-2 ml-2 mr-2" style=""
                    href="{{ url('export_advStudents_counseling_anecdotal_pdf', $student_wisd->id) }}"><span
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_counseling_anecdotal_record/' . $student_wisd->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control" value="{{ $student_wisd->student->gender }}"
                                    readonly>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $student_wisd->date_time_called->format('F d,  Y - g:i A') }}" readonly>
                            </div>

                            <div class="form-group mt-3">
                                <label for="" style="color:dimgray">Reason/s for Contact: </label>
                                <input type="text" class="form-control" name="reasons_for_contact"
                                    value="{{ $student_wisd->reasons_for_contact }}">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" value="{{ $student_wisd->student->age }}"
                                    readonly>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control" name="referred_by"
                                    value="{{ $student_wisd->referred_by }}">
                            </div>

                            <div class="form-group mt-3">
                                <label for="" style="color:dimgray">Follow up Counseling Session: </label>
                                <input type="text" class="form-control" name="follow_up_counseling_session"
                                    value="{{ $student_wisd->follow_up_counseling_session }}">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class=" p-2 bg-light" style="border: 1px solid dimgray;">
                                ...
                                <input type="text" class="form-control text-center" style="width: 45px;"
                                    name="student_id" value="{{ $student_wisd->student_id }}" readonly>
