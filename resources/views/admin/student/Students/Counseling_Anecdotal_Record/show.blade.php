...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student/' . $student_wisd->student->id . '/counseling_anecdotal_record') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        ...
        href="{{ url('export_advStudents_counseling_anecdotal_pdf', $student_wisd->id) }}"><span class="fas fa-file-pdf"
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_counseling_anecdotal_record/' . $student_wisd->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
