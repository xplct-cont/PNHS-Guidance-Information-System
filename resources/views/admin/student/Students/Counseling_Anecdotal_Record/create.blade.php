...
@section('content')
    <div class="p-3">
        <a class="fas fa-arrow-left" style="font-size:20px; color:blue;"
            href="{{ url('show-student/' . $student_wis->id . '/counseling_anecdotal_record') }}"></a>
    </div>
    <div class="row d-flex justify-content-center text-dark">
        <div class="col-md-9 elevation-1 p-3 mb-3 rounded bg-light">
            ...
            <div class="row d-flex justify-content-center text-dark">
                <h1 class="text-dark text-center" style="font-size: 25px;">Counseling Anecdotal Record</h1>
            </div>
                    ...
                    <div class="container mb-0">
                        <form action="{{ url('/add_counseling_anecdotal_record') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio inline mr-5">
                                            <input type="radio" name="follow_up_counseling_session" value="Voluntary">
                                            <span>Voluntary</span>
                                        </label>
                                    </div>
                                </div>
