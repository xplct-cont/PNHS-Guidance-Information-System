...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student/' . $student_wisd->student->id . '/parent_conference_record') }}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        ...
        href="{{ url('export_advStudents_parent_conference_record_pdf', $student_wisd->id) }}"><span class="fas fa-file-pdf"
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_parent_conference_record/' . $student_wisd->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
