...
@section('content')
    <div class="p-1">
        <a class="fas fa-arrow-left" style="font-size:20px; color:blue;"
            href="{{ url('show-student/' . $student_wisd->student->id . '/parent_conference_record') }}"></a>
    </div>
        ...
        <div class="col-md-11 elevation-4 p-3 rounded  mt-3 bg-light mb-3">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a class="btn btn-danger mt-2 ml-2 mr-2" style=""
                    href="{{ url('export_advStudents_parent_conference_record_pdf', $student_wisd->id) }}"><span
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_parent_conference_record/' . $student_wisd->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" value="{{ $student_wisd->student->parent_name }}"
                                    readonly>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reason_for_contact"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="inquiries_referral_appointment"
                                    value="{{ $student_wisd->inquiries_referral_appointment }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        ...
                        <div class="form-group text-center ">
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" name="action_taken"
                                    value="{{ $student_wisd->action_taken }}">
                            </div>
                        </div>
                        ...
                        <input type="text" class="form-control text-center" style="width: 45px;" name="student_id"
                            value="{{ $student_wisd->student_id }}" readonly>
