...
<div class="search" style="position:relative; top: 5px;">
    ...
    <a href="{{ url('/advisory-list/'.$adviser->id. '/add-new-student/') }}" class="btn btn-primary ml-2" style="margin-top: 10px;"><span
                ...
                <div class="card-body">
                    <div class="" style="position: relative; top:-20px;">
                        <a class="btn btn-secondary mt-2 ml-2 mr-2" style=""
                            href="{{ url('export_advStudents_pdf/'. $adviser->id) }}"><span class="fas fa-file-pdf text-danger"
                                style="font-size: 15px;"></span> PDF</a>
                        <a href="{{'/export_advStudents_excel/' . $adviser->id}}" class=" mt-2 ml-2 btn btn-secondary"><span
                            ...
                            <tbody>
                                @forelse ($advStudents as $adv)
                                    <tr class="text-center">
                                        ...
                                        <td><input type="checkbox" name="ids[]" value="{{ $adv->id }}"></td>
                                    </tr>

                                @empty
                                    <tr>
                                        <td colspan="5" class="text-dark"><span
                                                class="fas fa-exclamation-circle text-danger"></span> No students found!</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
