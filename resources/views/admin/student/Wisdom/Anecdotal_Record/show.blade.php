...
@section('content')
<div class="p-1">
    <a class="fas fa-arrow-left" style="font-size:20px; color:blue;" href="{{ url('show-student/' . $student_wisd->student->id . '/anecdotal_record' )}}"></a>
</div>
    ...
    <div class="row d-flex justify-content-center text-dark">
        ...
        href="{{ url('export_advStudents_anecdotal_pdf', $student_wisd->id) }}"><span class="fas fa-file-pdf"
            ...
            <div class="container mx-auto">
                ...
                <form action="{{ url('update_anecdotal_record/' . $student_wisd->id) }}" method="POST" accept-charset="UTF-8">
                    @csrf
                    @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $student_wisd->observation_date_time->format('F d,  Y - g:i A') }}" readonly>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $student_wisd->student->user->name }}" readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-12 mb-3 mt-2">
                        <div class=" p-2 bg-light" style="border: 1px solid dimgray;">
                            ...
                            <input type="text" class="form-control text-center" style="width: 45px;" name="student_id" value="{{ $student_wisd->student->id }}" readonly>
                            </div>
                            <br>
