...
<div class="p-1">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('/upload_student_information') }}" method="POST"
    ...
    <form action="{{ url('update_student_information_sheet/' . $stud_info_wis->id) }}" method="POST" accept-charset="UTF-8">
        @csrf
        @method('PUT')

        <div class="row d-flex justify-content-center text-dark">
            <div class="col-md-11 elevation-4 p-3 rounded  mt-2 bg-light mb-3">
                <a href="{{ url('delete_student_information_sheet/' . $stud_info_wis->id) }}"
