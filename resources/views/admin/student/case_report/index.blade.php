...
@section('content')
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-secondary" style="font-weight:400" id="exampleModalLabel">Create new
                            case...</h5>
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/create_case_report') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="container mx-auto">

                                <div class="d-flex justify-content-center">
                                    <img src="/images/image17.png" class="user-image"
                                        alt="User Image"
                                        style="width: 185px; height:150px; padding-left: 2px; padding-right:2px; padding-bottom:2px; padding-top: 2px;">
                                </div>
                                ...
                                <h1 class="text-center mt-4"
                                    ...
                                    Pangangan National High School </h1>
                                <p class="text-center"
                                    style="font-weight:bold; font-size: 20px; color:rgba(60, 58, 58, 0.904);">Guidance
                                    Office</p>
                                <p class="text-center text-dark" style="position: relative; top: -15px;">Talisay, Calape,
                                    Bohol</p>


                                <p class="text-center text-dark"
                                    style="font-size: 15px; font-weight: 500; color:rgba(60, 58, 58, 0.904); ">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="width: 45px;" class="form-control text-center"
    ...
    <a class="btn btn-secondary ml-2 mr-2" style="" href="{{ route('export_allCases_pdf') }}"><span
            class="text-danger fas fa-file-pdf" style="font-size: 15px;"></span> PDF</a>

    <p class="text-dark p-2">Guidance Designate: <span class="text-dark"
            style="border-bottom: 1px solid dimgray">{{ Auth::user()->name }}</span></p>
                ...
                <thead class="text-light p-2" style="background-color:rgb(173, 173, 173);">
                    <tr>
                        ...
                        <th class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                            Grade & Section</th>
                        <th class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">Sex
                        </th>
                        <th>Date Reported</th>
                        <th class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">Name
                            of Respondents</th>
                        <th class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                            Grade & Section</th>
                        <th class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">Sex
                    ...
                    @forelse ($case_reports as $reports)
                        <tr class="text-secondary">
                            ...
                            <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                                {{ $reports->grade_section }}</td>
                            <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                                {{ $reports->sex }}</td>
                            <td>{{ Carbon\Carbon::parse($reports->date_reported)->format('F d,  Y ') }}</td>
                            <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                                {{ $reports->resp_name }}</td>
                            <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                                {{ $reports->resp_grade_section }}</td>
                            <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                                {{ $reports->resp_sex }}</td>
                            <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell" style="text-align: center">
                                {{ $reports->nature_of_complaint }}</td>
                            ...
                            <div class="modal fade" id="reports_id{{ $reports->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog " role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ url('delete_case_report/' . $reports->id) }}" method="GET"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-dark"><span
                                    class="fas fa-exclamation-circle text-danger"></span>
