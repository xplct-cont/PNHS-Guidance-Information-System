                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="advisory" type="text" class="form-control @error('advisory') is-invalid @enderror" name="advisory" value="{{ old('advisory') }}" required autocomplete="advisory" autofocus placeholder="Grade 12 - Example">
